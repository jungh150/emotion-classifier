...
class ConvLSTMEmotionClassifier(nn.Module):
    def __init__(self, input_shape, num_classes):
        ...
        # Bidirectional LSTM 블록
        self.lstm = nn.LSTM(256, 128, num_layers=3, batch_first=True, dropout=0.3, bidirectional=True)
        
        # Fully Connected 블록
        self.fc = nn.Sequential(
            nn.Linear(128 * 2, 128),  # Bidirectional이므로 출력 크기 2배
            nn.ReLU(),
