...
parser.add_argument(
    "--flame_model_path",
    type=str,
    default="src/flame_pytorch/models/generic_model.pkl",
...
parser.add_argument(
    ...
    type=str,
    default="src/flame_pytorch/models/flame_static_embedding.pkl",
...
parser.add_argument(
    ...
    type=str,
    default="src/flame_pytorch/models/flame_dynamic_embedding.npy",
